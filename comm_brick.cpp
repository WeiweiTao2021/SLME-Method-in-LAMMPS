...
void CommBrick::exchange()
{
  ...
  //if(screen && comm->me == 0) fprintf(screen,"IN COMM EXCHANGE\n");
 ...
 //if(screen && comm->me == 0) fprintf(screen,"IN COMM EXCHANGE CLEAR AVEC ENDS\n");
  ...
  for (int dim = 0; dim < dimension; dim++) {
    ...
    while (m < nrecv) {
      ...
      //if(screen && comm->me == 0) fprintf(screen,"idm=%d ends\n", dim);
      
  }

  //if(screen && comm->me == 0) fprintf(screen,"COMM EXCHANGE for dim ENDS\n");
    
  if (atom->firstgroupname) atom->first_reorder();
    
    //if(screen && comm->me == 0) fprintf(screen,"COMM EXCHANGE ENDS\n");
}
